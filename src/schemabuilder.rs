...
use tantivy::schema::{
    Schema as TantivySchema, SchemaBuilder as TantivySchemaBuilder,
    TextOptions, NumericOptions, DateOptions, BytesOptions, IpAddrOptions,
    TextFieldIndexing, IndexRecordOption, INDEXED,
};
...
impl SchemaBuilder {
    ...
    #[napi]
    pub fn add_text_field(&mut self, name: String, options: Option<TextFieldOptions>) -> Result<&Self> {
    ...
    /// @returns Self for method chaining
    #[napi]
    pub fn add_integer_field(&mut self, name: String, options: Option<NumericFieldOptions>) -> Result<&Self> {
        let builder = self.inner.as_mut()
            .ok_or_else(|| Error::new(Status::InvalidArg, "Schema builder is no longer valid"))?;
    ...
    /// @returns Self for method chaining
    #[napi]
    pub fn add_unsigned_field(&mut self, name: String, options: Option<NumericFieldOptions>) -> Result<&Self> {
        let builder = self.inner.as_mut()
            .ok_or_else(|| Error::new(Status::InvalidArg, "Schema builder is no longer valid"))?;
    ...
    /// @returns Self for method chaining
    #[napi]
    pub fn add_float_field(&mut self, name: String, options: Option<NumericFieldOptions>) -> Result<&Self> {
        let builder = self.inner.as_mut()
            .ok_or_else(|| Error::new(Status::InvalidArg, "Schema builder is no longer valid"))?;
    ...
    /// @returns Self for method chaining
    #[napi]
    pub fn add_boolean_field(&mut self, name: String, options: Option<NumericFieldOptions>) -> Result<&Self> {
        let builder = self.inner.as_mut()
            .ok_or_else(|| Error::new(Status::InvalidArg, "Schema builder is no longer valid"))?;
    ...
    /// @returns Self for method chaining
    #[napi]
    pub fn add_date_field(&mut self, name: String, options: Option<NumericFieldOptions>) -> Result<&Self> {
        let builder = self.inner.as_mut()
            .ok_or_else(|| Error::new(Status::InvalidArg, "Schema builder is no longer valid"))?;
    ...
    /// @returns Self for method chaining
    #[napi]
    pub fn add_json_field(&mut self, name: String, options: Option<JsonFieldOptions>) -> Result<&Self> {
        let builder = self.inner.as_mut()
            .ok_or_else(|| Error::new(Status::InvalidArg, "Schema builder is no longer valid"))?;
    ...
    /// @returns Self for method chaining
    #[napi]
    pub fn add_bytes_field(&mut self, name: String, options: Option<BytesFieldOptions>) -> Result<&Self> {
        let builder = self.inner.as_mut()
            .ok_or_else(|| Error::new(Status::InvalidArg, "Schema builder is no longer valid"))?;
    ...
    /// @returns Self for method chaining
    #[napi]
    pub fn add_ip_addr_field(&mut self, name: String, options: Option<IpAddrFieldOptions>) -> Result<&Self> {
        let builder = self.inner.as_mut()
            .ok_or_else(|| Error::new(Status::InvalidArg, "Schema builder is no longer valid"))?;
...
impl SchemaBuilder {
    ...
    fn build_text_options(options: Option<TextFieldOptions>) -> Result<TextOptions> {
        ...
        let tokenizer_name = options.as_ref()
            .and_then(|o| o.tokenizer_name.as_deref())
            .unwrap_or("default");
        let index_option = options.as_ref()
