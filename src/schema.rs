...
/// Tantivy's Type
///
/// The variant names mirror `tantivy.FieldType` in tantivy-py rather than
/// tantivy's own Rust `Type` names.
#[napi]
...
impl From<FieldType> for tv::schema::Type {
  fn from(field_type: FieldType) -> tv::schema::Type {
    match field_type {
      ...
      FieldType::Boolean => tv::schema::Type::Bool,
...
impl FieldType {
  pub fn from_tantivy_type(field_type: &tv::schema::Type) -> Self {
    match field_type {
      tv::schema::Type::Str => FieldType::Text,
      tv::schema::Type::U64 => FieldType::Unsigned,
      tv::schema::Type::I64 => FieldType::Integer,
      tv::schema::Type::F64 => FieldType::Float,
      tv::schema::Type::Bool => FieldType::Boolean,
      tv::schema::Type::Date => FieldType::Date,
      tv::schema::Type::Facet => FieldType::Facet,
      tv::schema::Type::Bytes => FieldType::Bytes,
      tv::schema::Type::Json => FieldType::Json,
