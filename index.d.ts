...
export declare class Index {
   ...
   */
  static isCompatible(path: string): boolean
   ...
   * TextAnalyzer instance.)
   */
  registerFastFieldTokenizer(name: string, analyzer: TextAnalyzer): void
}
...
export declare class IndexWriter {
   ...
   */
  deleteDocuments(fieldName: string, fieldValue: unknown): bigint
  /**
...
export declare class Query {
   ...
   */
  static existsQuery(fastFieldName: string, jsonSubpaths?: boolean | undefined | null): Query
  /**
   ...
   *         text, or a `[offset, text]` pair giving its offset in the phrase.
   */
  static phrasePrefixQuery(schema: Schema, fieldName: string, words: Array<unknown>): Query
  /**
   ...
   */
  static regexPhraseQuery(
    schema: Schema,
    fieldName: string,
    words: Array<unknown>,
    slop?: number | undefined | null,
  ): Query
  /**
   ...
   */
  static booleanQuery(subqueries: Array<object>, minimumNumberShouldMatch?: number | undefined | null): Query
  /**
   ...
   * given query.
   */
  andMustMatch(queries: Array<Query>): Query
  /**
   ...
   * the given queries.
   */
  andMustNotMatch(queries: Array<Query>): Query
  /**
   ...
   * given queries.
   */
  orShouldMatch(queries: Array<Query>): Query
   ...
   */
  static moreLikeThisDocumentFieldsQuery(
    schema: Schema,
  ...
  static rangeQuery(
    ...
    fieldName: string,
    fieldType: FieldType,
    lowerBound?: unknown | undefined | null,
...
export declare class Searcher {
  ...
  search(
    ...
    weightByField?: string | undefined | null,
  ): SearchResult
  /**
   ...
   */
  aggregate(query: Query, agg: any): any
  /**
   ...
   */
  cardinality(query: Query, fieldName: string): number
   ...
   *         unsupported type.
   */
  fastFieldValues(fieldName: string, docAddresses: Array<DocAddress>): Array<number | boolean | undefined | null>
  /**
  ...
  termsWithPrefix(
    fieldName: string,
    prefix: string,
    filterQuery?: Query | undefined | null,
    limit?: number | undefined | null,
  ): Array<TermCount>
...
export declare function getTantivyVersion(): string
 ...
 * ```
 */
export declare function parseQueryLenient(query: string): [any, any]
